...
public class ProductoTest {
	...
	public void queSePuedaVenderAMinoristaPocaCantidad() {
		...
		distribuidora.venderPocaCantidadDeUnProducto(100, len, 5);
		distribuidora.venderPocaCantidadDeUnProducto(100, len, 5);
		distribuidora.venderPocaCantidadDeUnProducto(100, b, 5);
		assertFalse(distribuidora.venderPocaCantidadDeUnProducto(101, c, 5));
